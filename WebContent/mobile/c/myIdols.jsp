...
if(user==null){
	String bsUrl2="mobile/c/myIdols.jsp?userid="+myId;
	...
	response.sendRedirect(InfBoxUtil.SITE_URL+"/checkUser.jsp?siteid="+InfBoxUtil.siteId+"&fd_url="+bsUrl2+"&needId=1");
	return;
}
int myUserId=Integer.parseInt(myId);
MiscUtil.debug("myId="+myUserId);
ArrayList<Friend> friends=DemoUtil.getFriendList(myUserId,1, null);
%>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		<div class="prev">
			<a onclick="javascript:window.history.back();"><img class="go_back" src="img/icon_back.png"/></a>我关注的人
			<span>
